 ...
 *   entirely — no planned replacement), `v.isControllable`, and `f.sasMode`
 *   (shape mismatch: the real `vessel.control.sasMode` is a numeric enum,
 *   not the string this widget
