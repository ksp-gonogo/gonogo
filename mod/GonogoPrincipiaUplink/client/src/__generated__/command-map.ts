...
export const GENERATED_COMMAND_RAIL = {
  "principia.plan.arm": { replies: true },
  "principia.plan.burn.insert": { replies: true },
  "principia.plan.burn.remove": { replies: true },
  "principia.plan.burn.replace": { replies: true },
  "principia.plan.create": { replies: true },
  "principia.plan.delete": { replies: true },
  "principia.plan.duplicate": { replies: true },
  "principia.plan.horizon": { replies: true },
  "principia.plan.integrator": { replies: true },
  "principia.plan.send": { replies: true },
