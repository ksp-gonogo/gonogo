...
export const GENERATED_COMMAND_RAIL = {
  "principia.plan.arm": { continuity: "discrete", replies: true },
  "principia.plan.burn.insert": { continuity: "discrete", replies: true },
  "principia.plan.burn.remove": { continuity: "discrete", replies: true },
  "principia.plan.burn.replace": { continuity: "discrete", replies: true },
  "principia.plan.create": { continuity: "discrete", replies: true },
  "principia.plan.delete": { continuity: "discrete", replies: true },
  "principia.plan.duplicate": { continuity: "discrete", replies: true },
  "principia.plan.horizon": { continuity: "discrete", replies: true },
  "principia.plan.integrator": { continuity: "discrete", replies: true },
  "principia.plan.send": { continuity: "discrete", replies: true },
