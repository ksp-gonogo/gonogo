...
export const GENERATED_COMMAND_RAIL = {
  "kerbalism.file.delete": { replies: true },
  "kerbalism.file.send": { replies: true },
  "kerbalism.sample.analyze": { replies: true },
  "kerbalism.sample.dump": { replies: true },
  "kerbalism.sample.moveToLab": { replies: true },
