...
For stations out on the internet to connect, coturn has to be reachable from outside your home network. Forward these ports on your router to the machine running the relay. The ranges match `docker-compose.yml`:
